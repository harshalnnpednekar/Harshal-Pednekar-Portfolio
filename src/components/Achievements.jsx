    ...
    <div id="achievements" className="flex flex-col gap-10 z-10 relative w-full">
      ...
      <div className="flex flex-col gap-6 relative">
        ...
        {achievements.map((item, idx) => (
          <div
            key={idx}
            className="group relative p-6 md:p-8 rounded-3xl border border-white/10 bg-white/10 backdrop-blur-md overflow-hidden hover:border-white/50 hover:-translate-y-2 transition-all duration-500 shadow-2xl flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8 ml-0 md:ml-12 w-full"
          ...
          >
            ...
            <div className="hidden md:flex absolute -left-[54px] top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-white border-4 border-background z-10 shadow-[0_0_15px_rgba(255,255,255,0.8)] group-hover:scale-150 transition-transform duration-500"></div>
